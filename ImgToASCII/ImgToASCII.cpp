...
void ImgToASCII::parse_comment()
{
	...
	img >> size[0] >> size[1];
	std::cout << std::endl << "������������ (������ " << ((size[0] << 4) + size[1]) - 2 << " ��): " << std::endl;
...
void ImgToASCII::parse_kvant_table()
{
	...
	if (id.first)
		std::cout << std::endl << "������� ����������� (2 �����), ID: " << std::hex << (unsigned int)id.second << std::endl;
	else
		std::cout << std::endl << "������� ����������� (1 ����), ID: " << std::hex << (unsigned int)id.second << std::endl;
...
void ImgToASCII::parse_baseline_DCT()
{
	...
	std::cout << "���������� �����������: " << std::dec << width << "x" << height << std::endl;
	...
	for (unsigned int i = 0; i < 3; ++i)
	{
		...
		std::cout << "�������������� ������������: " << std::hex << (unsigned int)thinning.first  << " | ";
		std::cout << "������������   ������������: " << std::hex << (unsigned int)thinning.second << " | ";
		img >> byte;
		std::cout << "ID ������� �����������: " << std::hex << (unsigned int)byte << " | ";
		std::cout << std::endl;
	}
...
void ImgToASCII::parse_haffman_table()
{
	...
	if (id.first)
		std::cout << std::endl << "������� �������� (AC ����.), ID: " << std::hex << (unsigned int)id.second << std::endl;
	else
		std::cout << std::endl << "������� �������� (DC ����.), ID: " << std::hex << (unsigned int)id.second << std::endl;
...
void ImgToASCII::parse_start_of_scan()
{
	...
	img >> size[0] >> size[1];
	std::cout << "������ SOS: " << std::dec << join_bytes(size[0], size[1]) << std::endl;
	...
	for (unsigned int i = 0; i < chanel_cnt; ++i)
	{
		...
		img >> byte;
		std::pair<unsigned char, unsigned char> id = split_byte(byte);
		std::cout << "������������� ������� �������� ��� DC �������������: " << (unsigned int)id.first  << std::endl;
		std::cout << "������������� ������� �������� ��� AC �������������: " << (unsigned int)id.second << std::endl << std::endl;
	}
	img >> byte;
