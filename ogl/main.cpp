...
int main()
{
    ...
    Shader ourShader("./Shaders/src/VertexShader.glsl", "./Shaders/src/FragShader.glsl");
    ...
    int img_w, img_h;
    unsigned char* image = SOIL_load_image("./Textures/container.jpg", &img_w, &img_h, 0, SOIL_LOAD_RGB);
